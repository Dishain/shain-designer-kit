...
3. **UI-Builder** собирает реальную страницу: сетка галереи, типографика, тёмная палитра, аккуратные ховеры и микроанимации (через скилл Эмиля).
4. Параллельно **доступность** проверяет контраст и навигацию, а **копирайтер** доводит тексты.
5. **Tester** открывает результат в браузере, смотрит на мобильном и десктопе.
6. Claude показывает тебе **скриншот** и говорит, что именно проверил.
